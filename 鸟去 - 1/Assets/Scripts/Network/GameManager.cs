...
//public static string test;
    ...
    // 都是先找到在数组里的id，然后通过Player.CmdTouchEvent在服务器端调用该动物的TouchEvent。
...
//            LeftBorder.gameObject.SetActive(false);
            ...
            // 右边界的距离（是镜头高度的n倍，但不小于镜头的宽度）
            float borderDist = Mathf.Max(BorderWidthFactor * Global.CamHight * 2, Global.CamWidth * 2);
    ...
    public static void GameOverNetwork() {
